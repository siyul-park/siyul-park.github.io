...
[RFC 9220](https://datatracker.ietf.org/doc/rfc9220)은 HTTP/3에서의 WebSocket 확장에 대한 세부 사항을 정의합니다. 이것은 [RFC 8441](https://www.rfc-editor.org/rfc/rfc8441)과 유사한 웹 소켓 연결 방식을 HTTP/3 프로토콜에 적응시킵니다.
