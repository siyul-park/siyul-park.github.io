...
`테스트 대역`을 활용하면 코드의 독립성을 확보하고, 외부 의존성으로부터 모듈을 격리시킬 수 있습니다. 가상 데이터를 생성하여 외부 의존성에 영향받지 않고도 간소화된 테스트를 수행할 수 있어, 빠르고 독립적인 테스트 환경을 구축할 수 있습니다. 또한, `테스트 대역`을 활용함으로써 테스트 대상이 외부와 어떻게 상호작용을 하는지를 확인할 수 있게 해줍니다.
